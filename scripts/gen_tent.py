...
for ix in range(800):
    ...
    for jx in range(12):
        ...
        z = z * (z < 1.0) * (z > 0.0)
        cv2.imwrite('data/train/z%03d_%02d.png' % (ix, jx), z * 255)
...
for ix in range(200):
    ...
    for jx in range(12):
        z = (z < 0.5) * (2 * z) + (z >= 0.5) * (2 - 2 * z) + np.random.rand(32, 32) * 0.01
        z = z * (z < 1.0) * (z > 0.0)
        cv2.imwrite('data/validation/z%03d_%02d.png' % (ix, jx), z * 255)
...
for ix in range(500):
    ...
    for jx in range(12):
        z = (z < 0.5) * (2 * z) + (z >= 0.5) * (2 - 2 * z) + np.random.rand(32, 32) * 0.01
        z = z * (z < 1.0) * (z > 0.0)
        cv2.imwrite('data/test/z%03d_%02d.png' % (ix, jx), z * 255)
